...
try:
    from .vtk_utils import generate_point_normals, calc_geodesic_distance, calc_surface_area, extract_surface
except:
    from vtk_utils import generate_point_normals, calc_geodesic_distance, calc_surface_area, extract_surface
...
def random_surface( full_surface, w_distance=1, w_normal=1, w_noise=1, surface_amount=None, center_point_id=None, rnd=None ):
    ...
    print( "Original area:", full_area )
    print( "Partial area:", partial_area )
    print( "Selected amount: {:.2f}% (Target was {:.2f}%)".format( 100*partial_area/full_area,
        100*surface_amount ) )
