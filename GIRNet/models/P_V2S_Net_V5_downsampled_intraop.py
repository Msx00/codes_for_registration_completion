...
class PV2SNetV5DownsampledIntraop(nn.Module):
    """P-V2S-Net V5:
    ...
    def __init__( self, 
        ...
        ########################
        self.cross_att_0, self.cross_att_conv_0, self.level_0_out, self.upsample_0_to_1 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_1, self.cross_att_conv_1, self.level_1_out, self.upsample_1_to_2 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_2, self.cross_att_conv_2, self.level_2_out, self.upsample_2_to_3 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_3, self.cross_att_conv_3, self.level_3_out, self.upsample_3_to_4 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_4, self.cross_att_conv_4, self.level_4_out, self.upsample_4_to_5 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_5, self.cross_att_conv_5, self.level_5_out, _ = self._init_layer(
            embedding_size=embedding_size, 
    ...
    def _init_layer(
        self, 
        embedding_size, 
        n_input_features, # value features
        n_intermediate_features, 
        n_output_features, 
        n_query_features, 
        high_res_features,
        ...
        level_out = nn.Sequential(
            ...
            nn.Conv1d(n_intermediate_features, n_output_features, kernel_size=1)
        )
        ...
        if not last_layer:
            upsampling = LayerUpsample(
                ...
                n_high_res_features=high_res_features,
                n_output_features=n_intermediate_features,
                use_relative_coords=True, use_positional_encoding=True,
                embedding_size=embedding_size, n_attention_modules=8,
            )
    ...
    def forward(self, 
        ...
        features_preop_0 = self.cross_att_0(
                ...
                queries_coords=coords_preop_0, 
                queries_features=features_preop_0,
        )
        ...
        features_preop_1 = self.cross_att_1(
                value_coords=coords_intraop_1, 
                value_features=features_intraop_1, 
                queries_coords=coords_preop_1, 
                queries_features=features_preop_1,
        )
        ...
        features_preop_2 = self.cross_att_2(
                value_coords=coords_intraop_2, 
                value_features=features_intraop_2, 
                queries_coords=coords_preop_2, 
                queries_features=features_preop_2,
        )
        ...
        features_preop_3 = self.cross_att_3(
                value_coords=coords_intraop_3, 
                value_features=features_intraop_3, 
                queries_coords=coords_preop_3, 
                queries_features=features_preop_3,
        )
        ...
        features_preop_4 = self.cross_att_4(
                value_coords=coords_intraop_4, 
                value_features=features_intraop_4, 
                queries_coords=coords_preop_4, 
                queries_features=features_preop_4,
        )
        ...
        features_preop_5 = self.cross_att_5(
                value_coords=coords_intraop_5, 
                value_features=features_intraop_5, 
                queries_coords=coords_preop_5, 
                queries_features=features_preop_5,
        )
