...
class PV2SNetV5DownsampledIntraopV2I2PDGCNN(nn.Module):
    """P-V2S-Net V5:
    1. 6 upsampling layers
    TODO: make the creation of layers flexible
    ...
    def __init__( self, 
        ...
        ########################
        self.cross_att_I2P_0, self.cross_att_P2I_0, self.level_0_out, self.upsample_0_to_1 = self._init_layer(
            embedding_size=embedding_size, 
        ...
        self.cross_att_I2P_1, self.cross_att_P2I_1, self.level_1_out, self.upsample_1_to_2 = self._init_layer(
            embedding_size = embedding_size, 
        ...
        self.cross_att_I2P_2, self.cross_att_P2I_2, self.level_2_out, self.upsample_2_to_3 = self._init_layer(
            embedding_size = embedding_size, 
        ...
        self.cross_att_I2P_3, self.cross_att_P2I_3, self.level_3_out, self.upsample_3_to_4 = self._init_layer(
            embedding_size = embedding_size, 
        ...
        self.cross_att_I2P_4, self.cross_att_P2I_4, self.level_4_out, self.upsample_4_to_5 = self._init_layer(
            embedding_size = embedding_size, 
        ...
        self.cross_att_I2P_5, self.cross_att_P2I_5, self.level_5_out, _ = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_intraop_features = n_intermediate_features[5],
        ...
        # Define the channel reduction layer
        self.reduce_channels = nn.Conv1d(in_channels=56, out_channels=n_preprocess_features, kernel_size=1)   
        # Initialize DGCNN layers
        
        self.dgcnn_4 = LayerDGCNN_v3(
            in_features=n_preprocess_features,      
            out_features=n_preprocess_features
        ) 
        self.dgcnn_3 = LayerDGCNN_v3(
            in_features=n_preprocess_features,      
            out_features=n_preprocess_features
        )       
        self.dgcnn_2 = LayerDGCNN_v3(
            in_features=n_preprocess_features,      
            out_features=n_preprocess_features
        )
        self.dgcnn_1 = LayerDGCNN_v3(
            in_features=n_preprocess_features,
            out_features=n_preprocess_features
        )
        self.dgcnn_0 = LayerDGCNN_v3(
            in_features=n_preprocess_features,
            out_features=n_preprocess_features
        )   
    ...
    def _init_layer(
        ...
        cross_att_I2P = LayerCrossAttention(
            ...
            n_output_features = n_cross_att_intraop_features,
            embedding_size=embedding_size,
            n_kneighbors = n_kneighbors,
        ...
        cross_att_P2I = LayerCrossAttention(
            ...
            n_value_features = n_cross_att_intraop_features,
            n_output_features = n_intermediate_features,
            embedding_size=embedding_size,
            n_kneighbors = n_kneighbors,
            use_relative_coords = True,
        ...
        # cross_att_conv = nn.Conv1d(n_intermediate_features, n_intermediate_features, kernel_size=1)
        ...
        return cross_att_I2P, cross_att_P2I, level_out, upsampling
    ...
    def forward(self, 
        ...
        features_intraop = torch.cat((features_intraop, coords_intraop), dim = 1)
        features_preop = torch.cat((features_preop, coords_preop), dim = 1) # [2, 5, 2500] -> [2, 56, 2500]
        features_intraop = self.reduce_channels(features_intraop)
        features_preop = self.reduce_channels(features_preop)
        ...
        neighbors_coords_preop_4, neighbors_preop_inds_4 = k_nearest_neighbors(pos_source=coords_preop_5, pos_queries=coords_preop_4, k=self.points_per_region)
        neighbors_features_preop_4 = select_point_regions(source=features_preop_5, indices=neighbors_preop_inds_4)
        features_preop_4 = self.dgcnn_4(features_preop_4, neighbors_features_preop_4)
        ...
        neighbors_coords_preop_3, neighbors_preop_inds_3 = k_nearest_neighbors(pos_source=coords_preop_4, pos_queries=coords_preop_3, k=self.points_per_region)
        neighbors_features_preop_3 = select_point_regions(source=features_preop_4, indices=neighbors_preop_inds_3)
        features_preop_3 = self.dgcnn_3(features_preop_3, neighbors_features_preop_3)
        ...
        neighbors_coords_preop_2, neighbors_preop_inds_2 = k_nearest_neighbors(pos_source=coords_preop_3, pos_queries=coords_preop_2, k=self.points_per_region)
        neighbors_features_preop_2 = select_point_regions(source=features_preop_3, indices=neighbors_preop_inds_2)
        features_preop_2 = self.dgcnn_2(features_preop_2, neighbors_features_preop_2)
        ...
        neighbors_coords_preop_1, neighbors_preop_inds_1 = k_nearest_neighbors(pos_source=coords_preop_2, pos_queries=coords_preop_1, k=self.points_per_region)
        neighbors_features_preop_1 = select_point_regions(source=features_preop_2, indices=neighbors_preop_inds_1)
        features_preop_1 = self.dgcnn_1(features_preop_1, neighbors_features_preop_1)
        ...
        neighbors_coords_preop_0, neighbors_preop_inds_0 = k_nearest_neighbors(pos_source=coords_preop_1, pos_queries=coords_preop_0, k=self.points_per_region)
        neighbors_features_preop_0 = select_point_regions(source=features_preop_1, indices=neighbors_preop_inds_0)
        features_preop_0 = self.dgcnn_0(features_preop_0, neighbors_features_preop_0)
        ...
        neighbors_coords_intraop_4, neighbors_intraop_inds_4 = k_nearest_neighbors(pos_source=coords_intraop_5, pos_queries=coords_intraop_4, k=self.points_per_region)
        neighbors_features_intraop_4 = select_point_regions(source=features_intraop_5, indices=neighbors_intraop_inds_4)
        features_intraop_4 = self.dgcnn_4(features_intraop_4, neighbors_features_intraop_4)
        ...
        neighbors_coords_intraop_3, neighbors_intraop_inds_3 = k_nearest_neighbors(pos_source=coords_intraop_4, pos_queries=coords_intraop_3, k=self.points_per_region)
        neighbors_features_intraop_3 = select_point_regions(source=features_intraop_4, indices=neighbors_intraop_inds_3)
        features_intraop_3 = self.dgcnn_3(features_intraop_3, neighbors_features_intraop_3)
        ...
        neighbors_coords_intraop_2, neighbors_intraop_inds_2 = k_nearest_neighbors(pos_source=coords_intraop_3, pos_queries=coords_intraop_2, k=self.points_per_region)
        neighbors_features_intraop_2 = select_point_regions(source=features_intraop_3, indices=neighbors_intraop_inds_2)
        features_intraop_2 = self.dgcnn_2(features_intraop_2, neighbors_features_intraop_2)
        ...
        neighbors_coords_intraop_1, neighbors_intraop_inds_1 = k_nearest_neighbors(pos_source=coords_intraop_2, pos_queries=coords_intraop_1, k=self.points_per_region)
        neighbors_intraop_features_1 = select_point_regions(source=features_intraop_2, indices=neighbors_intraop_inds_1)
        features_intraop_1 = self.dgcnn_1(features_intraop_1, neighbors_intraop_features_1)
        ...
        neighbors_coords_intraop_0, neighbors_intraop_inds_0 = k_nearest_neighbors(pos_source=coords_intraop_1, pos_queries=coords_intraop_0, k=self.points_per_region)
        neighbors_intraop_features_0 = select_point_regions(source=features_intraop_1, indices=neighbors_intraop_inds_0)
        features_intraop_0 = self.dgcnn_0(features_intraop_0, neighbors_intraop_features_0)
        ...
        # features_intraop_1 = self.level_1_processing( features_intraop_0 )
        features_preop_1 = self.upsample_0_to_1(coords_preop_0, features_preop_0,
        ...
        ##########################
        ## Level 2:
        # features_intraop_2 = self.level_2_processing( features_intraop_1 )
        features_preop_2 = self.upsample_1_to_2(coords_preop_1, features_preop_1,
        ...
        ##########################
        ## Level 3:
        # features_intraop_3 = self.level_3_processing( features_intraop_2 )
        features_preop_3 = self.upsample_2_to_3(coords_preop_2, features_preop_2,
        ...
        ##########################
        ## Level 4:
        # features_intraop_4 = self.level_4_processing( features_intraop_3 )
        features_preop_4 = self.upsample_3_to_4(coords_preop_3, features_preop_3,
        ...
        ##########################
        ## Level 5:
        # features_intraop_5 = self.level_5_processing( features_intraop_4 )
        features_preop_5 = self.upsample_4_to_5(coords_preop_4, features_preop_4,
