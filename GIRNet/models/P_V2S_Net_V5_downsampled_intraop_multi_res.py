...
class PV2SNetV5DownsampledIntraopMultiRes(nn.Module):
    ...
    def __init__( self, 
        ...
        ########################
        self.cross_att_0, self.level_0_out, self.upsample_0_to_1 = self._init_layer(
            embedding_size=embedding_size, 
            n_cross_att_value_features_list = [n_intermediate_features[0], n_intermediate_features[1], n_intermediate_features[2],],
            n_cross_att_query_features = n_preprocess_features, 
        ...
        self.cross_att_1, self.level_1_out, self.upsample_1_to_2 = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_value_features_list = [n_intermediate_features[0], n_intermediate_features[1], n_intermediate_features[2],],
            n_cross_att_query_features = n_intermediate_features[0], 
            n_intermediate_features = n_intermediate_features[1], 
            n_level_output_features = n_output_features, 
            n_upsample_high_res_features = n_preprocess_features,
            n_kneighbors = self.points_per_region,
        )
        self.cross_att_2, self.level_2_out, self.upsample_2_to_3 = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_value_features_list = [n_intermediate_features[1], n_intermediate_features[2], n_intermediate_features[3],],
            n_cross_att_query_features = n_intermediate_features[1], 
            n_intermediate_features = n_intermediate_features[2], 
            n_level_output_features = n_output_features, 
            n_upsample_high_res_features = n_preprocess_features,
            n_kneighbors = self.points_per_region,
        )
        self.cross_att_3, self.level_3_out, self.upsample_3_to_4 = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_value_features_list = [n_intermediate_features[2], n_intermediate_features[3], n_intermediate_features[4],],
            n_cross_att_query_features = n_intermediate_features[2], 
            n_intermediate_features = n_intermediate_features[3], 
            n_level_output_features = n_output_features, 
            n_upsample_high_res_features = n_preprocess_features,
            n_kneighbors = self.points_per_region,
        )   
        self.cross_att_4, self.level_4_out, self.upsample_4_to_5 = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_value_features_list =  [n_intermediate_features[3], n_intermediate_features[4], n_intermediate_features[5],],
            n_cross_att_query_features = n_intermediate_features[3], 
            n_intermediate_features = n_intermediate_features[4], 
            n_level_output_features = n_output_features, 
            n_upsample_high_res_features = n_preprocess_features,
            n_kneighbors = self.points_per_region,
        )
        self.cross_att_5, self.level_5_out, _ = self._init_layer(
            embedding_size = embedding_size, 
            n_cross_att_value_features_list = [n_intermediate_features[3], n_intermediate_features[4], n_intermediate_features[5],],
            n_cross_att_query_features = n_intermediate_features[4], 
    ...
    def _init_layer(
        self, 
        embedding_size, 
        n_cross_att_value_features_list, # value features
        n_cross_att_query_features, 
        n_intermediate_features, 
        ...
        """Initialize each layer of the network, including 
            ...
            4: upsampling
        """
        cross_att = LayerCrossAttentionMultiResolution(
            n_query_features = n_cross_att_query_features,
            n_value_features_list = n_cross_att_value_features_list,
        ...
        return cross_att, level_out, upsampling
    ...
    def forward(self, 
        ...
        features_preop_0 = self.cross_att_0(
                value_coords_list= [coords_intraop_0, coords_intraop_1, coords_intraop_2],
                value_features_list= [features_intraop_0, features_intraop_1, features_intraop_2],
        ...
        features_preop_1 = self.cross_att_1(
                value_coords_list = [coords_intraop_0, coords_intraop_1, coords_intraop_2],
                value_features_list = [features_intraop_0, features_intraop_1, features_intraop_2],
        ...
        features_preop_2 = self.cross_att_2(
                value_coords_list = [coords_intraop_1, coords_intraop_2, coords_intraop_3],
                value_features_list = [features_intraop_1, features_intraop_2, features_intraop_3],
        ...
        features_preop_3 = self.cross_att_3(
                value_coords_list = [coords_intraop_2, coords_intraop_3, coords_intraop_4],
                value_features_list = [features_intraop_2, features_intraop_3, features_intraop_4],
        ...
        features_preop_4 = self.cross_att_4(
                value_coords_list = [coords_intraop_3, coords_intraop_4, coords_intraop_5],
                value_features_list = [features_intraop_3, features_intraop_4, features_intraop_5],
        ...
        features_preop_5 = self.cross_att_5(
                value_coords_list = [coords_intraop_3, coords_intraop_4, coords_intraop_5],
                value_features_list = [features_intraop_3, features_intraop_4, features_intraop_5],
