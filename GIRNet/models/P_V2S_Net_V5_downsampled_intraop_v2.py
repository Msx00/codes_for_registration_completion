...
class PV2SNetV5DownsampledIntraopV2(nn.Module):
    """P-V2S-Net V5:
    ...
    def __init__( self, 
        ...
        self.cross_att_0, self.level_0_out, self.upsample_0_to_1 = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[0],
            # n_intermediate_features=n_intermediate_features[0],
            # n_output_features=n_output_features,
            # n_query_features=n_preprocess_features,
            # high_res_features=n_preprocess_features,
            # n_kneighbors=min(self.points_per_region, self.n_intermediate_points[0]),
            embedding_size=embedding_size, 
            n_cross_att_value_features = n_intermediate_features[0], 
        ...
        self.cross_att_1, self.level_1_out, self.upsample_1_to_2 = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[1],
            # n_intermediate_features=n_intermediate_features[1],
            # n_output_features=n_output_features,
            # n_query_features=n_intermediate_features[0],
            # high_res_features=n_preprocess_features,
            # n_kneighbors=self.points_per_region,
            embedding_size = embedding_size, 
            n_cross_att_value_features = n_intermediate_features[1],
        ...
        self.cross_att_2, self.level_2_out, self.upsample_2_to_3 = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[2],
            # n_intermediate_features=n_intermediate_features[2],
            # n_output_features=n_output_features,
            # n_query_features=n_intermediate_features[1],
            # high_res_features=n_preprocess_features,
            # n_kneighbors=self.points_per_region,
            embedding_size = embedding_size, 
            n_cross_att_value_features = n_intermediate_features[2],
        ...
        self.cross_att_3, self.level_3_out, self.upsample_3_to_4 = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[3],
            # n_intermediate_features=n_intermediate_features[3],
            # n_output_features=n_output_features,
            # n_query_features=n_intermediate_features[2],
            # high_res_features=n_preprocess_features,
            # n_kneighbors=self.points_per_region,
            embedding_size = embedding_size, 
            n_cross_att_value_features = n_intermediate_features[3],
        ...
        self.cross_att_4, self.level_4_out, self.upsample_4_to_5 = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[4],
            # n_intermediate_features=n_intermediate_features[4],
            # n_output_features=n_output_features,
            # n_query_features=n_intermediate_features[3],
            # high_res_features=n_preprocess_features,
            # n_kneighbors=self.points_per_region,
            embedding_size = embedding_size, 
            n_cross_att_value_features = n_intermediate_features[4],
        ...
        self.cross_att_5, self.level_5_out, _ = self._init_layer(
            # embedding_size=embedding_size, 
            # n_input_features=n_intermediate_features[5],
            # n_intermediate_features=n_intermediate_features[5],
            # n_output_features=n_output_features,
            # n_query_features=n_intermediate_features[4],
            # high_res_features=n_preprocess_features,
            # n_kneighbors=self.points_per_region,
            embedding_size = embedding_size, 
            n_cross_att_value_features = n_intermediate_features[5],
    ...
    def _init_layer(
        self, 
        embedding_size, 
        n_cross_att_value_features, # value features
        ...
        # )
        cross_att = LayerCrossAttention(
            n_query_features = n_cross_att_query_features,
            n_value_features = n_cross_att_value_features,
            n_output_features = n_intermediate_features,
            embedding_size=embedding_size,
            n_kneighbors = n_kneighbors,
