...
class LayerUpsampleOld(nn.Module):
    """Old upsampling layer
    ...
    def __init__( self,
        ...
        for i in range( n_attention_modules ):
            # att = MultiRegionAttention(
            att = MultiRegionAttentionForOldModels(
                n_value_features = n_low_res_features,
                n_query_features = n_high_res_features,
                n_output_features = n_output_features,
                embedding_size = embedding_size,
    ...
    def forward(self, low_res_coords, low_res_features, high_res_coords, high_res_features ):
