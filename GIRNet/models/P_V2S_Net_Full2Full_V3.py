...
from models.global_matcher import interpolate_flow_v2
from models.global_matcher_v3 import GlobalMatcherV3
from models.iterative_refiner_v3 import IterativeFlowRefinerV3
...
class PV2SNetFull2FullV3(nn.Module):
    ...
    def forward(self, source_xyz, target_xyz):
        ...
        global_memory_full = interpolate_flow_v2(
            query_coords=source_xyz,
            support_coords=source_global_coords,
            support_flow=match["global_memory"],
            k=3,
        )
