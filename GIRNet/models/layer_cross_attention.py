...
from models.attention import MultiRegionAttention, MultiRegionAgentAttention, MultiRegionAttentionMask, MultiRegionAttentionDisentangled
...
class LayerCrossAttention(nn.Module):
    ...
    def __init__( self,
            ...
            radius = None,
            embedding_size=64,
            use_absolute_coords_raw=True,
            use_relative_coords = False,
            use_positional_encoding = True,
            use_queries_to_values = True,
        ...
        if attention_type == 0:
            ...
            attention = MultiRegionAttentionMask
        elif attention_type == 4:
            attention = MultiRegionAttentionDisentangled
        else:
            raise ValueError("Unknown attention mode: {}".format(attention_mode))
        
        self.att_list = nn.ModuleList()
        for _ in range( n_attention_modules ):
            ...
            att = attention(
                ...
                concat_absolute_coords_raw = use_absolute_coords_raw,
                ...
                concat_queries_to_values = use_queries_to_values,
        ...
        # self.non_lin = nn.LeakyReLU(negative_slope=0.01)

    def forward(self, value_coords, value_features, query_coords, query_features, ): #low_res_features_skipconn=None):
