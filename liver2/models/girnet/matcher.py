"""Global source-to-target matching for GIRNet V3."""
...
def interpolate_source_features(
    query_coords,
    support_coords,
    support_features,
    k=3,
    ...
    """Interpolate source-indexed features with fixed squared-distance KNN."""
    ...
    batch_index = torch.arange(
        support_features.shape[0], device=support_features.device
    ).view(-1, 1, 1)
    neighbors = support_features[batch_index, nearest_index]
