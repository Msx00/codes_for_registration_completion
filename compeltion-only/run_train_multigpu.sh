...
SAVE_DIR="${SAVE_DIR:-${SCRIPT_DIR}/logs/full_aug_$(date +%Y%m%d_%H%M%S)}"

MAX_TRAIN_CASES="${MAX_TRAIN_CASES:-600}"
MAX_VAL_CASES="${MAX_VAL_CASES:-100}"
NUM_POINTS="${NUM_POINTS:-2048}"
CROPS_PER_GT="${CROPS_PER_GT:-4}"
OVERLAP_MIN="${OVERLAP_MIN:-0.25}"
OVERLAP_MAX="${OVERLAP_MAX:-0.25}"
ANCHOR_OVERLAP="${ANCHOR_OVERLAP:-0.25}"
ANCHOR_PROBABILITY="${ANCHOR_PROBABILITY:-0.50}"
